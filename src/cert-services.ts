...
import { Nordea as NordeaCert, NordeaServices as NordeaServicesCert } from './cacerts/Nordea'
import { debug, CertApplicationRequest } from './pankkiyhteys'

abstract class CertServiceBase extends SoapClient implements app.CertService {
  username: string
  environment: app.Environment

  abstract applicationRequestXmlns: string
  abstract certificateRequestXmlns: string
  abstract getEndpoint(environment: app.Environment): string
  abstract getRootCA(): string[]
...
export class OsuuspankkiCertService extends CertServiceBase {
...
export class NordeaCertService extends CertServiceBase {
  getEndpoint(): string {
  ...
  getRootCA(): string[] {
    return [NordeaCert, NordeaServicesCert]
  }
}
